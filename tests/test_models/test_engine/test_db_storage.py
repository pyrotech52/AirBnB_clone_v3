...
class TestDBStorage(unittest.TestCase):
    ...
    @unittest.skipIf(models.storage_t != 'db', "not testing db storage")
    def test_count(self):
        '''counts instances in db storage'''
        storage = models.storage
        storage.reload()
        ...
        city_data = {"name": "Abakpa", "state_id": state_instance.id}
        ...
        self.assertEqual(all_occurrence_occurrence, len(storage.all()))
